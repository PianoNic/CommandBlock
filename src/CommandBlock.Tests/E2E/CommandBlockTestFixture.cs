...
/// <summary>
/// Per-test helpers on top of the session-scoped <see cref="CommandBlockStack"/>.
...
/// </summary>
public static class CommandBlockTestFixture
{
    ...
    /// </summary>
    public static async Task<Session> NewAuthenticatedSessionAsync(CommandBlockStack stack)
    {
