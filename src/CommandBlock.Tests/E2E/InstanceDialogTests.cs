...
public class InstanceDialogTests
{
    ...
    private static async Task OpenEdit(IPage page, CommandBlockStack stack, string displayName)
    {
        await page.GotoAsync(stack.AppUrl + "/instances");
    ...
    private static async Task Run(Func<CommandBlockStack, IPage, string, Task> body, string prefix, bool skipOuterCleanup = false)
    {
