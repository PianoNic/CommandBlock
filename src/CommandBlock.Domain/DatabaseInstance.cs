namespace CommandBlock.Domain
{
    public class DatabaseInstance : BaseEntity
    {
        ...
        /// <summary>Null for externally-registered instances - CommandBlock didn't create a container for them.</summary>
        ...
        /// <summary>True for CommandBlock-provisioned containers, false for externally-registered databases.
        ...
        /// new CommandBlock-managed instance that holds the migrated data. The UI uses this to badge
