namespace CommandBlock.Domain
{
    ...
    /// created up front - from the "Add node" UI or declared in commandblock.yaml - and stay in a pending
    ...
    public class Node : BaseEntity
    {
        ...
        /// <summary>True when this node is declared in commandblock.yaml (commandblock.nodes). Config-managed rows
