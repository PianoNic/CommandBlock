namespace CommandBlock.API.Nodes
{
    // CommandBlock-owned wire contracts for node RPC. Deliberately NOT the Docker.DotNet model types:
    ...
    /// <summary>Everything CommandBlock sets when creating a container, in a transport-safe shape.</summary>
