...
namespace CommandBlock.Application.Mappings.Server
{
    ...
    {
        public static ServerInstanceDto ToDto(this CommandBlock.Domain.ServerInstance s, string? state = null, int? playersOnline = null, int? playersMax = null, long? memoryBytes = null, double? cpuPercent = null, long? memoryLimitBytes = null) => new()
        {
            Id = s.Id,
