...
{
    /// <summary>Root of the YAML file pointed to by CommandBlockOptions.InstancesFile.</summary>
    ...
    public sealed class ConfigInstance
    {
        ...
        /// <summary>Custom root password. Empty = auto-generate the first time, then CommandBlock
