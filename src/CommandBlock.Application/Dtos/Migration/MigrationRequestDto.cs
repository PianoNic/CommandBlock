namespace CommandBlock.Application.Dtos.Migration
{
    /// <summary>
    ...
    /// migrations explicitly. Source credentials are required because CommandBlock can't dump a DB it
    ...
    public record MigrationRequestDto
    {
        ...
        /// <summary>
        /// Compose context echoed back in the result's cleanup steps. CommandBlock does not edit the
