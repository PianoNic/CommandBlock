...
namespace CommandBlock.Application.Command.InnerUser
{
    ...
    public class CreateInnerUserCommandHandler(CommandBlockDbContext db, ISecretsVaultService vault, IInnerUserServiceResolver resolver, ISecretGeneratorService secretGenerator, ConfigManagedGuard guard) : ICommandHandler<CreateInnerUserCommand, InnerUserPasswordDto>
    {
