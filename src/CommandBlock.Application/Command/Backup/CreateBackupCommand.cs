...
namespace CommandBlock.Application.Command.Backup
{
    ...
    public class CreateBackupCommandHandler(CommandBlockDbContext db, ISecretsVaultService vault, IBackupServiceResolver resolver, IActivityLogger activity, IBackupStorage storage) : ICommandHandler<CreateBackupCommand, BackupEntryDto>
    {
