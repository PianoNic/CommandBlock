...
namespace CommandBlock.Application.Command.Backup
{
    ...
    public class RestoreBackupCommandHandler(CommandBlockDbContext db, ISecretsVaultService vault, IBackupServiceResolver resolver, IBackupStorage storage, IActivityLogger activity) : ICommandHandler<RestoreBackupCommand>
    {
