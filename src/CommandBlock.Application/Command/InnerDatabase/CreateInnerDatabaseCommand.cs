...
namespace CommandBlock.Application.Command.InnerDatabase
{
    ...
    public class CreateInnerDatabaseCommandHandler(CommandBlockDbContext db, ISecretsVaultService vault, IInnerDatabaseServiceResolver resolver, ConfigManagedGuard guard) : ICommandHandler<CreateInnerDatabaseCommand>
    {
