...
using CommandBlock.Application.Dtos.Migration;
using CommandBlock.Application.Dtos.Provision;
using CommandBlock.Infrastructure;
using CommandBlock.Infrastructure.Extensions;
using CommandBlock.Infrastructure.Interfaces;

namespace CommandBlock.Application.Command.Migration
{
    /// <summary>
    /// Guided migration from an externally-hosted (typically docker-compose-managed) database
    /// container into a fresh CommandBlock-managed instance. Streams progress events as it works so
        ...
        : IStreamCommandHandler<StreamMigrateContainerCommand, MigrationProgressDto>
    {
            ...
            [EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            // 2. Provision a fresh CommandBlock-managed instance. ProvisionDatabaseCommand creates the
            ...
            yield return Running(2, "provision-target", $"Provisioning new CommandBlock instance '{req.TargetDisplayName}'");
            ...
            // pg_dump/mysqldump installed on the CommandBlock host. Source is identified by its docker
