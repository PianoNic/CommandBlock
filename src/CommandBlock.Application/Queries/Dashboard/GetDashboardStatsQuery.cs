...
using CommandBlock.Application.Dtos.Dashboard;
using CommandBlock.Application.Mappings.Activity;
using CommandBlock.Infrastructure;
using CommandBlock.Infrastructure.Interfaces;

namespace CommandBlock.Application.Queries.Dashboard
{
    public record GetDashboardStatsQuery : IQuery<DashboardStatsDto>;

    public class GetDashboardStatsQueryHandler(CommandBlockDbContext db, IDockerServiceResolver dockerResolver)
