      ...
      @if (settings(); as s) {
        ...
        <section hlmCard class="flex min-h-0 flex-col">
          <div hlmCardHeader>
            ...
            <p hlmCardDescription>
              Host ports CommandBlock will allocate from per engine. Configured in <code class="font-mono">commandblock.yaml</code>.
            </p>
          </div>
        ...
        <section hlmCard class="flex min-h-0 flex-1 flex-col">
          <div hlmCardHeader>
            ...
            <p hlmCardDescription>Engines this instance of CommandBlock can provision, plus available versions.</p>
          </div>
          <div hlmCardContent class="min-h-0 flex-1 overflow-auto">
            <table hlmTable>
              <thead hlmTableHeader>
