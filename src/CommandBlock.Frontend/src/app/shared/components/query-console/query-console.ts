  ...
  private rebuild(): void {
    ...
    const state = EditorState.create({
      ...
      extensions: [
        ...
        commandblockEditorTheme(isDark),
        syntaxHighlighting(commandblockHighlightStyle(isDark)),
      ],
    });
...
function commandblockEditorTheme(_isDark: boolean): import('@codemirror/state').Extension {
...
function commandblockHighlightStyle(isDark: boolean): HighlightStyle {
  const colors = isDark
    ? {
