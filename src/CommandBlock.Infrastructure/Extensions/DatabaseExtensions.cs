...
namespace CommandBlock.Infrastructure.Extensions
{
    ...
    {
        // Postgres migrations live in CommandBlock.Infrastructure (the default assembly for the
        ...
        public const string SqliteMigrationsAssembly = "CommandBlock.Infrastructure.Migrations.Sqlite";

        private const string DefaultSqliteConnectionString = "Data Source=commandblock.db";

        public static DatabaseProvider GetDatabaseProvider(this IConfiguration configuration) =>
            ResolveProvider(configuration["Database:Provider"], configuration.GetConnectionString("CommandBlockDatabase"));
        ...
        public static IServiceCollection AddCommandBlockDatabase(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddDbContext<CommandBlockDbContext>(options => options.ConfigureCommandBlockProvider(provider, connectionString));
            return services;
        }

        public static DbContextOptionsBuilder ConfigureCommandBlockProvider(
